...
export const idlService = IDL.Service({
  ...
  'downloadVideo' : IDL.Func([IDL.Text], [ExternalBlob], []),
  'getCallerUserProfile' : IDL.Func([], [IDL.Opt(UserProfile)], ['query']),
  'getCallerUserRole' : IDL.Func([], [UserRole], ['query']),
  'getStripeSessionStatus' : IDL.Func([IDL.Text], [StripeSessionStatus], []),
  'getSubscriptionStatus' : IDL.Func([IDL.Principal], [IDL.Bool], ['query']),
  ...
  'listDownloads' : IDL.Func([], [IDL.Vec(DownloadRecord)], ['query']),
  ...
  'uploadVideo' : IDL.Func([VideoMetadata], [IDL.Text], []),
});
