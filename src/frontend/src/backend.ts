...
import type { ExternalBlob as _ExternalBlob, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole, VideoMetadata as _VideoMetadata, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async downloadVideo(arg0: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
    ...
    async getSubscriptionStatus(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getVideoMetadata(arg0: string): Promise<VideoMetadata> {
        if (this.processError) {
            try {
                ...
                return from_candid_VideoMetadata_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async listDownloads(): Promise<Array<DownloadRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.listDownloads();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadVideo(arg0: VideoMetadata): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadVideo(await to_candid_VideoMetadata_n21(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_VideoMetadata_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoMetadata): Promise<VideoMetadata> {
...
async function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        blobRef: await from_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value.blobRef),
        description: value.description,
        isLive: value.isLive,
        uploadedBy: value.uploadedBy,
        matchInfo: value.matchInfo
    };
}
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_VideoMetadata>): Promise<Array<VideoMetadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_VideoMetadata_n18(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_VideoMetadata_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: VideoMetadata): Promise<_VideoMetadata> {
...
async function to_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        title: value.title,
        thumbnailUrl: value.thumbnailUrl,
        blobRef: await to_candid_ExternalBlob_n23(_uploadFile, _downloadFile, value.blobRef),
        description: value.description,
        isLive: value.isLive,
        uploadedBy: value.uploadedBy,
        matchInfo: value.matchInfo
